...
function App() {
  ...
  return (
    <div className="App px-32 py-10 flex flex-col gap-5 h-screen ">
      <Search page={page} />
      {isLoading ? (
        <div role="status" className="h-full flex justify-center items-center">
          <svg
            aria-hidden="true"
            class="mr-2 w-20 h-20 text-gray-200 animate-spin dark:text-gray-200 fill-blue-600"
            viewBox="0 0 100 101"
            fill="none"
        ...
        <>
          <div className="flex h-screen gap-4 flex-wrap py-2   ">
            {users.map((user) => (
